<div class="wrapper grey-bg container clearfix forgot-btm-pad">
    <div class="breadcrumb  font-segoe mrgn-bot1">
        <ul>
            ...
            <li><a href="#">Conform Registration</a></li>
    ...
    <div class="garmin-banner">
        ...
        <h1 class="uppercase">conform Registration</h1>
    </div><!--garmin-banner end-->
    <div class="mrgn-top2">
        
        <div class="right-bar fl no-border">
            <div>
                 <span class="blue uppercase font14 mrgn-bot1">Your acoount has been activated. Now, You can login using your email and password.</span>
